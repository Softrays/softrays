...
md = {
  ...
  initDashboardPageCharts: function () {
    if (
      ...
      dataDailySalesChart = {
        labels: ["Excel", "Solid Works", "AutoCAD", "Revit", "Python", "Java", "C.Security", "Marketing", "CIC", "Photoshop", "Engr.", "Corel", "Motion", "CCNA", "CCNP", "SPSS", "Mini Importation", "Mobile App", "UI/UX", "Web (Frontend)", "Web (Backend)", "Siwes"],
        series: [[542, 443, 320, 780, 210, 473, 367, 123, 983, 62, 394, 434, 447, 961, 964, 942, 245, 526, 244, 369, 788, 019]],
      };
      ...
      var dataWebsiteViewsChart = {
        labels: ["Excel", "Solid Works", "AutoCAD", "Revit", "Python", "Java", "C.Security", "Marketing", "CIC", "Photoshop", "Engr.", "Corel", "Motion", "CCNA", "CCNP", "SPSS", "Mini Importation", "Mobile App", "UI/UX", "Web (Frontend)", "Web (Backend)", "Siwes"],
        series: [[542, 443, 320, 780, 210, 473, 367, 123, 983, 62, 394, 434, 447, 961, 964, 942, 245, 526, 244, 369, 788]],
      };
